...
import com.ati.lms.databinding.ActivityStudentRegistrationBinding;
import com.ati.lms.utils.ValidationUtils;

/**
 * StudentRegistrationActivity - Handles new student account creation
 */
public class StudentRegistrationActivity extends AppCompatActivity {
    ...
    private void attemptRegistration() {
        ...
        // Register
        long result = dbHelper.registerUser(fullName, email, password, "student", studentId, null);
